...
const langMessages = {
  en: {
    ...
    "printSend": {
      ...
      "bedNotClearedTitle": "A printer has finished a print | Some printers have finished a print",
      "bedNotClearedDetail": "Check that this printer's bed is clear before starting a new print: | Check that these printers' beds are clear before starting a new print:",
      "bedNotClearedConfirm": "The bed is clear | The beds are clear",
      ...
      "partialSendTitle": "One printer cannot receive this job | Some printers cannot receive this job",
      "partialSendSkipped": "The following printer will be skipped: | The following printers will be skipped:",
      "partialSendRemaining": "Continue sending to the remaining printer? | Continue sending to the remaining {0} printers?",
      ...
      "printerModelNotMatchShort": "Different model",
      "printerBusyFor": "{0}: Printer is not ready ({1})",
  ...
  zh_CN: {
    ...
    "printSend": {
      ...
      "bedNotClearedTitle": "打印机已完成上一次打印",
      "bedNotClearedDetail": "开始新打印前，请确认以下打印机的打印平台已清理：",
      "bedNotClearedConfirm": "平台已清理",
      "filamentError":"获取耗材信息失败，请确认打印机在线后点击刷新按钮重试，如未解决问题请寻求客服支持。",
      "alsoSendTo": "同时发送至",
      "partialSendTitle": "部分打印机无法发送",
      "partialSendSkipped": "以下打印机将被跳过：",
      "partialSendRemaining": "是否继续发送至其余 {0} 台打印机？",
      "partialSendConfirm": "继续",
      "printerFilamentUnreadable": "{0}：获取耗材信息失败",
      "printerModelNotMatchFor": "{0}：打印机与gcode文件不匹配",
      "printerModelNotMatchShort": "型号不匹配",
      "printerBusyFor": "{0}：打印机未就绪（{1}）",
